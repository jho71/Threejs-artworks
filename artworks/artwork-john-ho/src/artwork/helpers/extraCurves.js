...
class VivianiCurve extends Curve {
	...
	getPoint( t, optionalTarget = new Vector3() ) {
		...
		return point.set( x, y, z ).applyAxisAngle( axis, angle);;
...
class KnotCurve extends Curve {
	...
	getPoint( t, optionalTarget = new Vector3() ) {
		...
		return point.set( x, y-30, z ).multiplyScalar( this.scale );
...
class HelixCurve extends Curve {
	...
	getPoint( t, optionalTarget = new Vector3() ) {
		...
		return point.set( x, y, z ).multiplyScalar( this.scale ).applyAxisAngle( axis, angle);
