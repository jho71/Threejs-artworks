    ...
    function main() {
      {
        ...
        const texture = new TextureLoader().load("./assets/sky2.jpeg");
      ...
      loader_terrain.load("./assets/desert_Pillar_terrain.fbx", function (obj) {
      ...
      loader_trees.load("./assets/pinktree.glb", function (obj) {
      ...
      const cross = new TextureLoader().load("./assets/glow2.png");
      const v = new Vector3();
      ...
      //hover
      camera.position.set(
        3.538957295625084e-7,
        -1.021684878863786,
        -9.589670059257917e-7
      );
