...
import { ColorifyShader } from "./colorify-shader-mod.js";
...
function Art() {
  ...
  useEffect(() => {
    ...
    function onWindowResize(event) {
      ...
      renderer.setSize(
        inputEl.current.offsetWidth,
        inputEl.current.offsetHeight
      );
      composer.setSize(
        inputEl.current.offsetWidth,
        inputEl.current.offsetHeight
    ...
    function setupScene() {
      ...
      envTexture = loadEnv.load("./assets/eso0932a.jpeg");
