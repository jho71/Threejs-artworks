...
function Head({
  ...
  return (
    <NextHead>
      ...
      <link rel="manifest" href={`${baseUrl}/favicons/site.webmanifest`} crossOrigin="use-credentials" />
      <link rel="mask-icon" href={`${baseUrl}/favicons/safari-pinned-tab.svg`} color="#000000" />
      <link rel="shortcut icon" href={`${baseUrl}/favicons/favicon.ico`} />
      <meta name="msapplication-config" content={`${baseUrl}/favicons/browserconfig.xml`} />
      {/* Share meta tags */}
